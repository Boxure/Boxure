  ...
  return items.length > 0 ? (
    <div className="Market">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        ...
        <p className="text-gray-500 text-lg mb-6">Discover unique boxes or share your own creations.</p>
        <div>
          <Link href="/home">
        ...
        {loggedIn ? (
          <Link href="/add-box">
            <Button>Add Your Own Box</Button>
          </Link>
        ) : (
          ...
          {items.map((item) => (
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.target.src = QUESTION_MARK_IMG;
                }}
              />
